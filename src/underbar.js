(function() {
  ...
  _.delay = function(func, wait) {
    // iterate through the arguments, get the rest of the arguments after the first two
    // create setTimeout that will
      // after a certain amount of time, return a call on that functions()
